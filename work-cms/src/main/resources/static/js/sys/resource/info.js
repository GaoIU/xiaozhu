layui.use(['form', 'layer'], function() {
	...
	$.get("/sysResource/view", function(res) {
		...
		$('.parent').click(function() {
			...
			if(ul.hasClass('layui-show')) {
				...
				$(this).removeClass('fa-hand-o-down');
				$(this).addClass('fa-hand-o-right');
			} else {
				ul.addClass('layui-show');
				$(this).removeClass('fa-hand-o-right');
				$(this).addClass('fa-hand-o-down');
			}
		});
		
		$('.parent-selected ul li a').click(function() {
			var parentId = $(this).attr('lay-filter');
	...
	$('.parent-selected').click(function() {
